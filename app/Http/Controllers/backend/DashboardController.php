...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $creditsales = Sale::where('sales_status',0)->get();
        
        $totalcreditrevenue = 0;
        if ($creditsales) {
            foreach ($creditsales as $w) {
                $with = $w->price;
                $totalcreditrevenue += $with;
            }
        }
        ...
        return view('backend.dashboard.index', compact('totalcreditrevenue','totalrevenue', 'totalcategory', 'totalproduct', 'salescart'));
    }
