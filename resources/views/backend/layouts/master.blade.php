        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{route('user.dashboard')}}" class="site_title"><i class="fa fa-user"></i> <span> Supermarket System</span></a>
                </div>
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           {{-- <li>
                            ...
                            <li>
                                <a href="{{ url('/site/category/create') }}">
                                    <i class="fa fa-home"></i>
                                    Add Category
                                </a>
                            </li>
                            <li>
                                <a href="{{route('site.category.list')}}">
                                    <i class="fa fa-home"></i>
                                    View Category
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/site/products/create') }}">
       ...
       @yield('content')
        ...
        <footer>
            <div class="pull-right">
                Copy Right All Reserve <a href="http://www.bestshineeduapp.com">Bestshine Software Solution</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
