...
@section('title')
    Supermarket Bazar Dashboard Page
@endsection
@section('css')
        ...
        <div class="row tile_count" style="font-size: x-large;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="info-box brown-bg bg-primary" style="text-align: center;border-radius: 5px;">
                    ...
                    <div class="count">Rs.{{$totalrevenue}}</div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="btnSave" action="{{route('sales.store')}}" method="post">
                            ...
                            <br><input style="display:none;" type="text"  name="place" id="place" placeholder="Place"/>
